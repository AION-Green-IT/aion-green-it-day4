...
export const TASK3 = {
  ...
  closing: {
    ...
    placeholder: "Name what you are not funding or resourcing this year, and why that is defensible.",
  },
...
export const FIELDS = {
  target: {
    ...
    rationalePlaceholder: "Why this target is credible for Solenne.",
  },
  governance: {
    key: "governance",
    label: "Governance",
    ...
    escalationPlaceholder: "When does this escalate to the board?",
  ...
  investment: {
    ...
    rationaleLabel: "Rationale",
    rationalePlaceholder: "Why this stage, and not an earlier or later one.",
  },
  supplier: {
    key: "supplier",
    ...
    rationaleLabel: "Rationale",
    rationalePlaceholder: "Reference a risk flag from your Calculation Note.",
  },
  accountability: {
    key: "accountability",
